...
const BlogCard = ({ note, index, deleteItem, updateNote, showAlert }) => {
    ...
    useEffect(() => {
        ...
        const calculateRemainingTime = () => {
            ...
            const publishTime = new Date(note.publishDate);
            ...
            const timeDiff = currentDateUTC - currentTime;
            ...
            <tr className="cards">
                ...
                <td>
                    {remainingTime == null ? (
                        ...
                        <div>Publishing {remainingTime}</div>
                    )}
